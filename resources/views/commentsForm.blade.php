...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="table-container">
            <div class="title"> <h3>Notatki</h3> </div>
            @if ($errors->any())
            ...
            <div class="box box-primary ">
             <!-- /.box-header -->
             <!-- form start -->
             <form role="form"  action="{{ route('store1') }}" id="comment-form" 
               ...
               <div class="box">
                 <div class="box-body">
                   <div class="form-group{{ $errors->has('message')?'has-error':'' }}" id="roles_box">
                    ...
                    <textarea style="resize:none" name="message" id="message" cols="24" rows="4" required></textarea>
                   </div>
                 </div>
                </div>
