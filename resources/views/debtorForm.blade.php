               ...
               <div class="box">
                 <div class="box-body">
                   <div class="form-group{{ $errors->has('message')?'has-error':'' }}" id="roles_box">
                       <label><b>Dłużnik:</b></label> <br>
                       <input name="name" id="name" required></input><br>
                        <label><b>E-mail dłużnika:</b></label> <br>
                       <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"></input>
                       @error('email')
